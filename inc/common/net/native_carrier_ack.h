...
#define WORR_NATIVE_CARRIER_ACK_MAX_RANGES                              \
 ...
 * A successful COMMITTED result changes all three objects atomically.  Every
 ...
 * snapshot tombstone.  No caller-authored repeat/receipt API is exposed.
