...
extern cvar_t *bot_debug_aas;
extern cvar_t *bot_debug_route;
extern cvar_t *bot_debug_goal;
extern cvar_t *bot_debug_client;
extern cvar_t *bot_cpu_budget_ms;
extern cvar_t *bot_allow_chat;
extern cvar_t *bot_chat_team_only;
extern cvar_t *bot_chat_min_interval_ms;
extern cvar_t *bot_chat_reply_policy_smoke;
extern cvar_t *bot_chat_event_policy_smoke;
extern cvar_t *bot_chat_live_events;
extern cvar_t *bot_lifecycle_smoke;
...
public:
  ...
  inline entity_iterable_t(uint32_t start)
