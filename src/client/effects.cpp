...
static inline void CL_AddPlayerMuzzleFX(cl_muzzlefx_t fx, vec_t x, vec_t y, vec_t z, float scale)
{
    const vec3_t offset = { x, y, z };
    CL_AddPlayerMuzzleFX(fx, offset, scale);
}
...
void CL_MuzzleFlash(void)
{
    ...
    case MZ_BLASTER:
        ...
        CL_AddPlayerMuzzleFX(MFLASH_BLAST, 27.0f, 7.4f, -6.6f, 8.0f);
        break;
    ...
    case MZ_HYPERBLASTER:
        VectorSet(dl->color, 1, 1, 0);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/hyprbf1a.wav"), volume, ATTN_NORM, 0);
        CL_AddPlayerMuzzleFX(MFLASH_BLAST, 23.5f, 6.0f, -6.0f, 9.0f);
        break;
    case MZ_MACHINEGUN:
        VectorSet(dl->color, 1, 1, 0);
        ...
        CL_AddPlayerMuzzleFX(MFLASH_MACHN, 29.0f, 9.7f, -8.0f, 12.0f);
        break;
    case MZ_SHOTGUN:
        VectorSet(dl->color, 1, 1, 0);
        ...
        CL_AddPlayerMuzzleFX(MFLASH_SHOTG, 26.5f, 8.6f, -9.5f, 12.0f);
        break;
    case MZ_SSHOTGUN:
        VectorSet(dl->color, 1, 1, 0);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/sshotf1b.wav"), volume, ATTN_NORM, 0);
        CL_AddPlayerMuzzleFX(MFLASH_SHOTG2, 25.0f, 7.0f, -5.5f, 12.0f);
        break;
    case MZ_CHAINGUN1:
        ...
        Q_snprintf(soundname, sizeof(soundname), "weapons/machgf%ib.wav", (Q_rand() % 5) + 1);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound(soundname), volume, ATTN_NORM, 0);
        CL_AddPlayerMuzzleFX(MFLASH_MACHN, 29.0f, 9.7f, -10.0f, 12.0f);
        break;
    case MZ_CHAINGUN2:
        ...
        CL_AddPlayerMuzzleFX(MFLASH_MACHN, 29.0f, 9.7f, -10.0f, 16.0f);
        break;
    case MZ_CHAINGUN3:
        ...
        CL_AddPlayerMuzzleFX(MFLASH_MACHN, 29.0f, 9.7f, -10.0f, 20.0f);
        break;
    case MZ_RAILGUN:
        ...
        CL_AddPlayerMuzzleFX(MFLASH_RAIL, 20.0f, 5.2f, -7.0f, 12.0f);
        break;
    case MZ_ROCKET:
        ...
        CL_AddPlayerMuzzleFX(MFLASH_ROCKET, 20.8f, 5.0f, -11.0f, 10.0f);
        break;
    case MZ_GRENADE:
        VectorSet(dl->color, 1, 0.5f, 0);
        ...
        CL_AddPlayerMuzzleFX(MFLASH_LAUNCH, 18.0f, 6.0f, -6.5f, 9.0f);
        break;
    case MZ_BFG:
    ...
    case MZ_BFG2:
        VectorSet(dl->color, 0, 1, 0);
        CL_AddPlayerMuzzleFX(MFLASH_BFG, 18.0f, 8.0f, -7.5f, 16.0f);
        break;
    ...
    case MZ_PHALANX2:
        VectorSet(dl->color, 1, 0.5f, 0.5f);
        CL_AddPlayerMuzzleFX(MFLASH_ROCKET, 18.0f, 10.0f, -6.0f, 9.0f);
        break;
    case MZ_IONRIPPER:
        VectorSet(dl->color, 1, 0.5f, 0.5f);
        S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/rippfire.wav"), volume, ATTN_NORM, 0);
        CL_AddPlayerMuzzleFX(MFLASH_BOOMER, 24.0f, 3.8f, -5.5f, 15.0f);
        break;
    ...
    case MZ_ETF_RIFLE:
        ...
        CL_AddPlayerMuzzleFX(MFLASH_ETF_RIFLE, 24.0f, 5.25f, -5.5f, 4.0f);
        break;
    case MZ_SHOTGUN2:
        ...
        if (cl.csr.extended) {
            VectorSet(dl->color, 0.9f, 0.7f, 0);
            S_StartSound(NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/nail1.wav"), volume, ATTN_NORM, 0);
            CL_AddPlayerMuzzleFX(MFLASH_ETF_RIFLE, 24.0f, 4.0f, -5.5f, 4.0f);
        } else {
            VectorSet(dl->color, 1, 1, 0);
...
//      S_StartSound (NULL, mz.entity, CHAN_WEAPON, S_RegisterSound("weapons/bfg__l1a.wav"), volume, ATTN_NORM, 0);
        CL_AddPlayerMuzzleFX(MFLASH_BEAMER, 18.0f, 6.0f, -8.5f, 16.0f);
        break;
    case MZ_BLASTER2:
        VectorSet(dl->color, 0, 1, 0);
    ...
    case MZ_TRACKER:
        ...
        CL_AddPlayerMuzzleFX(MFLASH_DIST, 18.0f, 6.0f, -6.5f, 10.0f);
        break;
    case MZ_NUKE1:
        VectorSet(dl->color, 1, 0, 0);
        dl->die = cl.time + 100;
